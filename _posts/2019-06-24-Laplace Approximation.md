...
$$
\begin{align}
	\int exp(-\mathbb{E}(\theta_{i}))d\theta_{i} &\simeq exp(-\mathbb{E}(\hat{\theta}_{i})) \int exp\left(-\frac{1}{2}(\theta_{i}-\hat{\theta}_{i})^{T}\mathbf{A}(\theta_{i}-\hat{\theta}_{i})\right)d\theta_{i} \\
...
$$
\begin{align}
	\log{p(\mathcal{D}|\mathcal{M}_{i})} &\simeq \log{p(\mathcal{D}|\mathcal{M}_{i},\hat{\theta}_{i})}-\frac{M}{2}\log{|2\pi|}+\frac{1}{2}\log{|A_{0|}}-\frac{1}{2}(\hat{\theta_{i}}-\theta_{0})^{T}\mathbf{A}_{0}(\hat{\theta}_{i}-\theta_{0}) +\frac{M}{2}\log{|2\pi|}-\frac{1}{2}\log{|\mathbf{A}|} \\
